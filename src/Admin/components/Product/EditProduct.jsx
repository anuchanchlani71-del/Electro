...
function EditProduct() {
  ...
  const fetchproduct = async () => {
      const response = await axios.get(`http://localhost:8080/admin/findproduct?_id=${_id}`);
  ...
  const editProduct = async (e) => {
    ...
    const response = await axios.put(`http://localhost:8080/admin/editproduct/${_id}`, formData)
    console.log("response", response)
    if (response.data.success) {
                    ...
                    <form onSubmit={editProduct}>
                      ...
                      <div className="form-row">
                        ...
                        <div>
                          ...
                          <select
                            className="form-group col-md-12" style={{height:"30px"}}
