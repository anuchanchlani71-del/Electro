...
<div className="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
  <div className="row g-4 single-product">
    ...
    <div className="col-xl-6">
      ...
      <p className="mb-3">Category: {cat_id.name}</p>
      <h5 className="fw-bold mb-3">₹{price.toLocaleString("en-IN")}</h5>
      ...
      <div className="d-flex flex-column mb-3">
        ...
        <small>
          Available: <strong className="text-primary">{stock} items in stock</strong>
        </small>
      </div>
      <p className="mb-4">
       description
    ...
    <div className="col-lg-12">
      ...
      <div className="tab-content mb-5">
        ...
        >
          <p>
            Our new <b className="fw-bold">HPB12 / A12 battery</b> is rated at
            2000mAh and designed to power up Black and Decker / FireStorm line
            of 12V tools allowing users to run multiple devices off the same
            battery pack. The HPB12 is compatible with the following Black and
            Decker power tool models:
          </p>
          <b className="fw-bold">Black &amp; Decker Drills and Drivers:</b>
          <p className="small">
            BD12PSK, BDG1200K, BDGL12K, BDID1202, CD1200SK, CD12SFK, CDC1200K,
            CDC120AK, CDC120ASB, CP122K, CP122KB, CP12K, CP12KB, EPC12, EPC126,
            EPC126BK, EPC12CA, EPC12CABK, HP122K, HP122KD, HP126F2B, HP126F2K,
            HP126F3B, HP126F3K, HP126FBH, HP126FSC, HP126FSH, HP126K, HP128F3B,
          ...
          <b className="fw-bold mb-0">
            Best replacement for the following Black and Decker OEM battery part
            numbers:
          </b>
          <p className="small">
